            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="lg:col-span-2">
                  ...
                  <Input id="quotation_number" v-model="form.quotation_number" required class="mt-2" />
                </div>
                <div>
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div class="lg:col-span-2">
                  ...
                  <Input id="client_name" v-model="form.client_name" required class="mt-2" placeholder="Nombre completo del cliente" />
                </div>
                <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                  ...
                  <Input id="client_email" v-model="form.client_email" type="email" class="mt-2" placeholder="cliente@ejemplo.com" />
                </div>
                <div>
                  <Label for="client_phone">Teléfono</Label>
                  <Input id="client_phone" v-model="form.client_phone" class="mt-2" placeholder="+56 9 1234 5678" />
                </div>
                <div>
                  <Label for="client_address">Dirección</Label>
                  <Input id="client_address" v-model="form.client_address" class="mt-2" placeholder="Dirección completa" />
                </div>
              </div>
            </div>
...
const form = reactive({
  ...
  lead_id: props.quotation.lead_id || null,
  company_id: props.quotation.company_id || null,
  client_name: props.quotation.client_name,
  client_rut: props.quotation.client_rut || '',
  ...
  tax_rate: props.quotation.tax_rate,
...
onMounted(() => {
  // Items ya están cargados desde props
})
...
const onLeadChange = (leadId: number | null) => {
  if (!leadId) return
...
const submitForm = () => {
  ...
  router.put(route('quotations.update', props.quotation.id), form, {
    onSuccess: () => {
    ...
    onError: (errors) => {
      processing.value = false
      const errorMessage = Object.values(errors).flat().join(', ') || 'Error al actualizar la cotización'
      error(errorMessage)
    },
  })
}
